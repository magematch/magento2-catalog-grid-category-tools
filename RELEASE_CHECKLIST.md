...
- Verify stable install works: `composer require arjundhi/magento2-admin-product-grid-category-filter:^1.0`.
- Verify dev fallback works for pre-tag testing: `composer require arjundhi/magento2-admin-product-grid-category-filter:"dev-main@dev"`.
